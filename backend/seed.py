    ...
    try:
        ...
        for data in PRODUCTS:
            ...
            if not existing:
                ...
                db.add(p)
                seeded += 1
            elif "file_url" in data and data["file_url"] and not existing.file_url:
